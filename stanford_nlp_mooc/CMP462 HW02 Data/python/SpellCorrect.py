...
from GoodTuringModel import GoodTuringModel
...
def main():
  ...
  print 'Good Turing Language Model: '
  gtML = GoodTuringModel(trainingCorpus)
  customSpell = SpellCorrect(gtML, trainingCorpus)
